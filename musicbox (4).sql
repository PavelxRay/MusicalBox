...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 08 2023 г., 14:48
...
INSERT INTO `users` (`User_id`, `Login`, `Password`, `e-mail`, `Name`, `Surname`, `Admin_id`) VALUES
(1, 'ShiNOOBu', 'Nastorozhe13', 'hidukoff-pavel@yandex.ru', 'Павел', 'Хайдуков', 1),
(2, 'Billy', 'AbobA228', 't_anton08@mail.ru', 'Антон', 'Тощев', 0),
(3, 'PivishkoTyan', 'qwerty123', 'pivishko@mail.ru', 'Анна', 'Ерёмина', 0),
(5, '1', '1', '1', '1', '1', 0);
