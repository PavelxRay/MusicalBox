...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Main_user_changer_btn = QtWidgets.QPushButton(self.page_3)
        self.Main_user_changer_btn.setGeometry(QtCore.QRect(570, 10, 141, 51))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(15)
        self.Main_user_changer_btn.setFont(font)
        self.Main_user_changer_btn.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.Main_user_changer_btn.setObjectName("Main_user_changer_btn")
        ...
        self.Add_sons_list.addItem(item)
        item = QtWidgets.QListWidgetItem()
        font = QtGui.QFont()
        font.setPointSize(15)
        item.setFont(font)
        ...
        self.Users_lable = QtWidgets.QLabel(self.page_6)
        self.Users_lable.setGeometry(QtCore.QRect(25, 30, 741, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(30)
        font.setBold(False)
        font.setWeight(50)
        self.Users_lable.setFont(font)
        self.Users_lable.setStyleSheet("color: rgb(255, 170, 0);")
        self.Users_lable.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Users_lable.setObjectName("Users_lable")
        self.gridLayoutWidget_9 = QtWidgets.QWidget(self.page_6)
        self.gridLayoutWidget_9.setGeometry(QtCore.QRect(20, 490, 751, 51))
        ...
        self.Delete_user_btn = QtWidgets.QPushButton(self.gridLayoutWidget_9)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(18)
        font.setBold(False)
        ...
        self.Delete_user_btn.setStyleSheet("background-color: rgb(255, 85, 127);")
        self.Delete_user_btn.setObjectName("Delete_user_btn")
        self.gridLayout_11.addWidget(self.Delete_user_btn, 0, 0, 1, 1)
        self.Users_to_main_btn = QtWidgets.QPushButton(self.gridLayoutWidget_9)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
        self.Users_to_main_btn.setFont(font)
        self.Users_to_main_btn.setStyleSheet("background-color: rgb(255, 170, 127);")
        self.Users_to_main_btn.setObjectName("Users_to_main_btn")
        self.gridLayout_11.addWidget(self.Users_to_main_btn, 0, 1, 1, 1)
        self.Users_list = QtWidgets.QListWidget(self.page_6)
        self.Users_list.setGeometry(QtCore.QRect(20, 90, 751, 341))
        self.Users_list.setObjectName("Users_list")

        self.Change_data_user_btn = QtWidgets.QPushButton(self.page_6)
        self.Change_data_user_btn.setGeometry(QtCore.QRect(20, 450, 751, 37))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
        self.Change_data_user_btn.setFont(font)
        self.Change_data_user_btn.setStyleSheet("background-color: rgb(170, 170, 255);")
        self.Change_data_user_btn.setObjectName("Change_data_user_btn")
        self.stackedWidget.addWidget(self.page_6)
        self.page_7 = QtWidgets.QWidget()
        self.page_7.setObjectName("page_7")
        self.gridLayoutWidget_10 = QtWidgets.QWidget(self.page_7)
        self.gridLayoutWidget_10.setGeometry(QtCore.QRect(130, 60, 543, 415))
        ...
        self.Ch_email_textbox = QtWidgets.QLineEdit(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.Ch_email_textbox.setFont(font)
        self.Ch_email_textbox.setObjectName("Ch_email_textbox")
        self.gridLayout_14.addWidget(self.Ch_email_textbox, 4, 1, 1, 1)
        self.Ch_login_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        self.Ch_login_label.setFont(font)
        self.Ch_login_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Ch_login_label.setObjectName("Ch_login_label")
        self.gridLayout_14.addWidget(self.Ch_login_label, 3, 0, 1, 1)
        self.Ch_email_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight SemiConde")
        font.setPointSize(20)
        self.Ch_email_label.setFont(font)
        self.Ch_email_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Ch_email_label.setObjectName("Ch_email_label")
        self.gridLayout_14.addWidget(self.Ch_email_label, 4, 0, 1, 1)
        self.Ch_name_textbox = QtWidgets.QLineEdit(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.Ch_name_textbox.setFont(font)
        self.Ch_name_textbox.setObjectName("Ch_name_textbox")
        self.gridLayout_14.addWidget(self.Ch_name_textbox, 6, 1, 1, 1)
        self.Ch_login_textbox = QtWidgets.QLineEdit(self.gridLayoutWidget_10)
        self.Ch_login_textbox.setEnabled(True)
        self.Ch_login_textbox.setSizeIncrement(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.Ch_login_textbox.setFont(font)
        self.Ch_login_textbox.setObjectName("Ch_login_textbox")
        self.gridLayout_14.addWidget(self.Ch_login_textbox, 3, 1, 1, 1)
        self.Ch_surename_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        self.Ch_surename_label.setFont(font)
        self.Ch_surename_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Ch_surename_label.setObjectName("Ch_surename_label")
        self.gridLayout_14.addWidget(self.Ch_surename_label, 8, 0, 1, 1)
        self.Ch_surename_textbox = QtWidgets.QLineEdit(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.Ch_surename_textbox.setFont(font)
        self.Ch_surename_textbox.setObjectName("Ch_surename_textbox")
        self.gridLayout_14.addWidget(self.Ch_surename_textbox, 8, 1, 1, 1)
        self.Ch_password_textbox = QtWidgets.QLineEdit(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.Ch_password_textbox.setFont(font)
        self.Ch_password_textbox.setEchoMode(QtWidgets.QLineEdit.Password)
        self.Ch_password_textbox.setObjectName("Ch_password_textbox")
        self.gridLayout_14.addWidget(self.Ch_password_textbox, 9, 1, 1, 1)
        self.Ch_password_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        self.Ch_password_label.setFont(font)
        self.Ch_password_label.setStyleSheet("")
        self.Ch_password_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Ch_password_label.setObjectName("Ch_password_label")
        self.gridLayout_14.addWidget(self.Ch_password_label, 9, 0, 1, 1)
        self.Change_data_users_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStrikeOut(False)
        self.Change_data_users_label.setFont(font)
        self.Change_data_users_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Change_data_users_label.setObjectName("Change_data_users_label")
        self.gridLayout_14.addWidget(self.Change_data_users_label, 1, 1, 1, 1)
        self.MB_label_8 = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Niagara Engraved")
        font.setPointSize(60)
        self.MB_label_8.setFont(font)
        self.MB_label_8.setStyleSheet("color: rgb(255, 170, 127);")
        self.MB_label_8.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.MB_label_8.setObjectName("MB_label_8")
        self.gridLayout_14.addWidget(self.MB_label_8, 0, 1, 1, 1)
        self.Ch_name_label = QtWidgets.QLabel(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        self.Ch_name_label.setFont(font)
        self.Ch_name_label.setAlignment(QtCore.Qt.AlignBottom | QtCore.Qt.AlignHCenter)
        self.Ch_name_label.setObjectName("Ch_name_label")
        self.gridLayout_14.addWidget(self.Ch_name_label, 6, 0, 1, 1)
        self.Chnge_to_main_btn = QtWidgets.QPushButton(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        font.setBold(False)
        ...
        font.setStrikeOut(False)
        font.setKerning(True)
        self.Chnge_to_main_btn.setFont(font)
        self.Chnge_to_main_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.Chnge_to_main_btn.setStyleSheet("background-color: rgb(170, 170, 255);")
        self.Chnge_to_main_btn.setObjectName("Chnge_to_main_btn")
        self.gridLayout_14.addWidget(self.Chnge_to_main_btn, 11, 1, 1, 1)
        self.Change_data_user_last_page_btn = QtWidgets.QPushButton(self.gridLayoutWidget_10)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiLight Condensed")
        font.setPointSize(20)
        font.setBold(False)
        ...
        font.setStrikeOut(False)
        font.setKerning(True)
        self.Change_data_user_last_page_btn.setFont(font)
        self.Change_data_user_last_page_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.Change_data_user_last_page_btn.setStyleSheet("background-color: rgb(170, 85, 127);")
        self.Change_data_user_last_page_btn.setObjectName("Change_data_user_last_page_btn")
        self.gridLayout_14.addWidget(self.Change_data_user_last_page_btn, 10, 1, 1, 1)
        ...
        # Выход из программы
        self.Out_action.triggered.connect(QtWidgets.qApp.quit)

        # Рикролл
        self.action.triggered.connect(self.open_youtube)
        ...
        # Кнопка запуска первого плейлиста
        self.Pl_1_btn.clicked.connect(self.playlist_one)

        # Кнопка запуска второго плейлиста
        self.Pl_2_btn.clicked.connect(self.playlist_two)

        self.Main_user_changer_btn.clicked.connect(self.changing_users)

        self.Users_to_main_btn.clicked.connect(self.to_main_page)

        self.Chnge_to_main_btn.clicked.connect(self.to_main_page)

        self.Delete_user_btn.clicked.connect(self.delete_user_from_database)

        self.Change_data_user_btn.clicked.connect(self.to_changer_page)

        self.Change_data_user_last_page_btn.clicked.connect(self.changer)
    ...
    def to_changed_users(self):
        self.stackedWidget.setCurrentIndex(5)

        # Функция "Добавить новую песню в плейлист"
    ...
    def to_main_page(self):
        ...
        self.Playlist_label.setText("Созданный плейлист")

    def to_changer_page(self):
        self.stackedWidget.setCurrentIndex(6)
        self.change_user_in_database()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Main_user_changer_btn.setText(_translate("MainWindow", "Изменить\n"
                                                                    " пользователей"))
        ...
        self.Users_lable.setText(_translate("MainWindow", "Пользователи"))
        self.Delete_user_btn.setText(_translate("MainWindow", "Удалить пользователя"))
        self.Users_to_main_btn.setText(_translate("MainWindow", "Выйти на главную страницу"))
        ...
        self.Change_data_user_btn.setText(_translate("MainWindow", "Изменить данные выбранного пользователя"))
        self.Ch_login_label.setText(_translate("MainWindow", "Логин"))
        self.Ch_email_label.setText(_translate("MainWindow", "e-mail"))
        self.Ch_surename_label.setText(_translate("MainWindow", "Фамилия"))
        self.Ch_password_label.setText(_translate("MainWindow", "Пароль"))
        self.Change_data_users_label.setText(_translate("MainWindow", "Изменение данных пользователя"))
        self.MB_label_8.setText(_translate("MainWindow", "MUSICALBOX"))
        self.Ch_name_label.setText(_translate("MainWindow", "Имя"))
        self.Chnge_to_main_btn.setText(_translate("MainWindow", "Вернуться на главную страницу"))
        self.Change_data_user_last_page_btn.setText(_translate("MainWindow", "Изменить данные"))
    ...
    # Функция открытия первого плейлиста
    def playlist_one(self):
        # подключение к базе данных
        db = pymysql.connect(host=host, user=user, password=password, db=db_name)
        cursor = db.cursor()

        query = "SELECT music.MusicName, autor.AutorName FROM music " \
                "JOIN autor ON music.Autor_id = autor.Autor_id WHERE music.pl = 1 "
        cursor.execute(query)

        results = cursor.fetchall()

        self.Playlist_label.setText("Плейлист №1")
        for result in results:
            music_name = result[0]
            autor_name = result[1]
            self.Add_sons_list.addItem(f"{music_name} - {autor_name}")
    ...
    # Функция открытия второго плейлиста
    def playlist_two(self):
        # подключение к базе данных
        db = pymysql.connect(host=host, user=user, password=password, db=db_name)
        cursor = db.cursor()

        query = "SELECT music.MusicName, autor.AutorName FROM music " \
                "JOIN autor ON music.Autor_id = autor.Autor_id WHERE music.pl = 2 "
        cursor.execute(query)

        results = cursor.fetchall()

        self.Playlist_label.setText("Плейлист №2")
        for result in results:
            music_name = result[0]
            autor_name = result[1]
            self.Add_sons_list.addItem(f"{music_name} - {autor_name}")
    ...
    def changing_users(self):
        global admin_checked
        if admin_checked == 1:
            self.select_user_to_change()
            self.to_changed_users()
        else:
            self.show_error_message("У вас нет прав!")

    def select_user_to_change(self):
        try:
            # Подключение к базе данных
            connection = pymysql.connect(
                host=host,
            ...
            result = cursor.fetchall()
            print(result)
            self.add_tuple_to_list_for_users(result)
    ...
    def add_tuple_to_list_for_users(self, tuple_item):
        for i in tuple_item:
            user_id = i[0]
            user_login = i[1]
            user_password = i[2]
            ...
            user_surname = [5]
            user_admin_id = [6]
            string_item = f"{user_login}"
            item = QtWidgets.QListWidgetItem()
            font = QtGui.QFont()
            font.setPointSize(15)
            item.setFont(font)
            item.setCheckState(QtCore.Qt.Checked)
            self.Users_list.addItem(string_item)
        __sortingEnabled = self.Users_list.isSortingEnabled()
        self.Users_list.setSortingEnabled(False)
    ...
    def delete_user_from_database(self):
        user_login = self.Users_list.currentItem().text()
        try:
            # Подключение к базе данных
            connection = pymysql.connect(
                host=host,
            ...
            cursor.close()
            connection.close()
            self.show_message("Пользователь успешно удалён!")
            selected_item = self.Users_list.currentItem()
            self.Users_list.takeItem(self.Users_list.row(selected_item))

        except pymysql.Error as e:
            print(f"Ошибка при подключении к базе данных: {e}")

    def change_user_in_database(self):
        global user_llogin
        user_login = self.Users_list.currentItem().text()
        try:
            # Подключение к базе данных
            ...
            print("Connection already11")
            # Создание объекта курсора
            cursor = connection.cursor()

            # Проверка, что логин не занят
            query = "SELECT Login, Password, `e-mail`, Name, Surname  FROM users WHERE Login=%s"
            cursor.execute(query, (user_login,))
            result = cursor.fetchone()

            print(result)

            user_llogin = result[0]

            self.Ch_login_textbox.setText(result[0])
            self.Ch_email_textbox.setText(result[2])
            self.Ch_name_textbox.setText(result[3])
            self.Ch_surename_textbox.setText(result[4])
            self.Ch_password_textbox.setText(result[1])
    ...
    def changer(self):
        global user_llogin
        user_login = self.Ch_login_textbox.text()
        user_mail = self.Ch_email_textbox.text()
        user_name = self.Ch_name_textbox.text()
        user_surname = self.Ch_surename_textbox.text()
        user_password = self.Ch_password_textbox.text()
        ...
        try:
            ...
            # Проверка, что логин не занят
            query = "UPDATE users SET Login=%s, Password=%s, `e-mail`=%s, Name=%s, Surname=%s WHERE Login=%s"
            cursor.execute(query, (user_login, user_password, user_mail, user_name, user_surname, user_llogin))
            result = cursor.fetchone()
            print(result)
            connection.commit()
            self.show_message("Данные пользователя успешно изменены!")
            self.to_main_page()
