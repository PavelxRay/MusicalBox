...
" пользователей"))
        ...
        self.Delete_user_btn.setText(_translate("MainWindow", "Удалить выбранные песни из БД"))
        ...
        item.setText(_translate("MainWindow", "456"))
        item = self.Users_list.item(2)
        item.setText(_translate("MainWindow", "789"))
        item = self.Users_list.item(3)
        item.setText(_translate("MainWindow", "000"))
        item = self.Users_list.item(4)
        item.setText(_translate("MainWindow", "111"))
        item = self.Users_list.item(5)
        item.setText(_translate("MainWindow", "222"))
        item = self.Users_list.item(6)
        item.setText(_translate("MainWindow", "333"))
        item = self.Users_list.item(7)
        item.setText(_translate("MainWindow", "444"))
        item = self.Users_list.item(8)
        item.setText(_translate("MainWindow", "555"))
        item = self.Users_list.item(9)
        item.setText(_translate("MainWindow", "666"))
        item = self.Users_list.item(10)
        item.setText(_translate("MainWindow", "777"))
        item = self.Users_list.item(11)
        item.setText(_translate("MainWindow", "888"))
        item = self.Users_list.item(12)
        item.setText(_translate("MainWindow", "999"))
    ...
    def add_song_in_playlist(self):
            ...
            b = (
                    "INSERT INTO music (MusicName, Autor_id, Albom, Date, href) VALUES (%s, %s, %s, %s)",
                    (song_name, albom, date_of_song, href_of_song))
            cursor.execute(b)
